...
#
# 操作服务阶段同样注入 SUPD_SERVICE / SUPD_SERVICE_DIR，默认值仅用于手动脱离 supd 的脚本测试。
set -u
...
echo "Operation:       ${SUPD_OPERATION:-unknown}"
echo "Phase:           ${SUPD_OPERATION_PHASE:-service}"
echo "Execution ID:    ${SUPD_OPERATION_EXECUTION_ID:-unknown}"
